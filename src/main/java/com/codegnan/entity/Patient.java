...
public class Patient extends Person {
	...
	public Patient(Integer id, String name, String email, String mobile,
				   String gender, String strRegDate, Integer age)
	...
	public Patient(String name, String email, String mobile,
				   String gender, String strRegDate, Integer age)
			throws InvalidDateFormatException {
	...
	public String toString() {
		String dateStr = regDate == null ? "N/A"
				: new SimpleDateFormat("dd-MM-yyyy").format(regDate);
		return "Patient [ " + super.toString() +
				", regDate=" + dateStr + ", age=" + age + "]";
	}
}
