...
public class Visit {
	...
	public Visit(Integer id, String strDate, String disease,
				 Double weight, Double temperature, Double bp,
	...
	public Visit(String strDate, String disease,
				 Double weight, Double temperature, Double bp,
				 String modeOfPayment) throws InvalidDateFormatException {
		setDate(strDate);
		this.disease = disease;
	...
	public String toString() {
		...
		return "Visit [id=" + id + ", date=" + strDate + ", disease=" + disease +
				", weight=" + weight + ", temperature=" + temperature +
				", bp=" + bp + ", modeOfPayment=" + modeOfPayment + "]";
	}
}
